...
class Ass {
    ...
    // WebHomeTV fork note: system fonts are provided via nativeAssInit ->
    // ass_set_fonts_dir("/system/fonts"); no manual font registration here (avoids ~190MB
    // duplicated font data per player instance and OOM crashes).
